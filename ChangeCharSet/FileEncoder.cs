...
namespace ChangeCharSet
{
    ...
    public class FileEncoder
    {
        ...
        internal static string[] nicename = new string[]
       {
        ...
        /// </code>
        /// </example>
        public virtual Encoding GetEncodingName(System.Uri testurl)
        {
            ...
            String dada=GetEncodingName(rawtext);
            switch (dada)
            {
                case "GB2312": en = Encoding.GetEncoding("GB2312"); break;
                case "GBK": en = Encoding.GetEncoding("GBK"); break;
                case "HZ": en = Encoding.GetEncoding("HZ"); break;
                case "Big5": en = Encoding.GetEncoding("Big5"); break;
                case "CNS 11643": en = Encoding.GetEncoding("CNS 11643"); break;
                case "ISO 2022CN": en = Encoding.GetEncoding("ISO 2022CN"); break;
                case "UTF-8": en = Encoding.GetEncoding("UTF-8"); break;
                case "Unicode": en = Encoding.GetEncoding("Unicode"); break;
                case "ASCII": en = Encoding.GetEncoding("ASCII"); break;
                case "OTHER": en = Encoding.GetEncoding("OTHER"); break;
            }
            return en;
        }
        ...
        /// </code>
        /// </example>
        public virtual Encoding GetEncodingName(System.IO.FileInfo testfile)
        {
            ...
            Encoding en = Encoding.Default;
            switch (GetEncodingName(rawtext))
            {
                case "GB2312": en = Encoding.GetEncoding("GB2312"); break;
                case "GBK": en = Encoding.GetEncoding("GBK"); break;
                case "HZ": en = Encoding.GetEncoding("HZ"); break;
